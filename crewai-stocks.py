...
def fetch_stock_price(ticket):
    stock = yf.download(ticket, start="2023-01-01", end="2024-08-20")
    return stock


yahoo_finance_tool = Tool(
    name = "Yahoo Finance Tool",
    description = "Fetchs stockk prices for {ticket} from the las year about a specific stock from Yahoo Finance API",
...
#IMPORTANDO A TOOL DE SEARCH DUCK DUCK GO
...
newsAnalyst = Agent(
    ...
    You understand news, theirs tittles and information, but you look at those with a health dose of skepticism. You consider also the source
...
getNews = Task(
    ...
    Include a fear/gredd score for each asset based on the news. Use format:
    <STOCK ASSET>
...
writeAnalyses = Task(
    ...
    """,
    expected_output= """An eloquent 3 paragraphs newsletter formated as markdown in an easy readable manner. It should contains:
